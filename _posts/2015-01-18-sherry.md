...
* [codecademy python](http://www.codecademy.com/en/tracks/python),如果网速快的话强烈推荐这个作为交互式环境。
* [tutorialspoint python](http://www.tutorialspoint.com/execute_python_online.php),这个可能打开也有点慢。如果快的话优先3和4,1和2是一个个人博客里面的，做的不太好。
